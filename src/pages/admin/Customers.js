                ...
                <main className="p-6 sm:p-10 space-y-6 bg-gray-800">
                    ...
                    <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
                        ...
                        <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-purple-600 bg-purple-100 rounded-full mr-6">
                            ...
                            <div>
                                <span className="block text-2xl font-bold">{customers.length}</span>
                            ...
                            <div className="overflow-y-auto">
                                <ul className="p-6 space-y-6">
                                    ...
                                    <li className="flex items-center">
                                        ...
                                        <span className="ml-auto font-semibold">{customer.fleets}</span>
                                        <span className="ml-auto font-semibold">{customer.drones}</span>
                                    </li>)}
                                </ul>
                            </div>
                        </div>
