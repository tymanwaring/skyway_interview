                    ...
                    <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
                        <div className="flex items-center p-8 bg-white shadow rounded-lg">
                            ...
                            <div>
                                ...
                                <span className="block text-gray-500">Drones</span>
                            </div>
                        </div>
                        <div className="flex items-center p-8 bg-white shadow rounded-lg">
                            ...
                            <div className="overflow-y-auto">
                                ...
                                {fleets.map((fleet) =>             
                                    <li className="flex items-center">
                                        <span className="text-gray-600">{fleet.id}</span>
                                        <span className="ml-auto font-semibold">{fleet.name}</span>
                                        <span className="ml-auto font-semibold">{fleet.drones.length} Drones</span>
                                    </li>)}
                                </ul>
                            </div>
                        </div>
